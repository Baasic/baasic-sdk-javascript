...
import { BaasicOrganizationBatchClient, BaasicOrganizationRouteDefinition } from 'modules/userProfile';
...
export class BaasicOrganizationClient {
    ...
    constructor(
        protected baasicOrganizationRouteDefinition: BaasicOrganizationRouteDefinition,
        protected baasicOrganizationBatchClient: BaasicOrganizationBatchClient
    ) {}
     ...
     **/
    find(options?: IOptions): Promise<IBaasicQueryModel<IOrganization>> {
        return this.baasicApiHttp.get(this.baasicOrganizationRouteDefinition.find(options));
    }
     ...
     **/
    get(id: string, options?: IOptions): Promise<IOrganization> {
        return this.baasicApiHttp.get(this.baasicOrganizationRouteDefinition.get(id, options));
    }
    ...
    create(data: IOrganization): Promise<IOrganization> {
        return this.baasicApiHttp.post(this.baasicOrganizationRouteDefinition.create(), this.baasicOrganizationRouteDefinition.createParams(data)); 
    }
     ...
     **/					
    update(data: IOrganization): Promise<void> {
        return this.baasicApiHttp.put(this.baasicOrganizationRouteDefinition.update(data), this.baasicOrganizationRouteDefinition.updateParams(data));
    }
     ...
     **/	
    remove(data: IOrganization): Promise<any> {
        return this.baasicApiHttp.delete(this.baasicOrganizationRouteDefinition.delete(data));
    }
}