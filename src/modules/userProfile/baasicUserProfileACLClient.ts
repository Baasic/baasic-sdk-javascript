...
export class BaasicUserProfileACLClient {
    ...
    update(options: IACLOptions): PromiseLike<IHttpResponse<IACLPolicy[]>> {
        return this.baasicApiClient.put<IACLPolicy[]>(this.baasicUserProfileACLRouteDefinition.get(options), this.baasicUserProfileACLRouteDefinition.updateParams(options));
    }
