/* globals module */
/**  
 * @module dashboardLoginClient  
 * @description  Dashboard Login Client provides an easy way to consume  Application Registration REST API end-points. In order to obtain needed routes `loginClient` uses `loginRoute`. 
 */
...
import { DashboardLoginRoute, TYPES as membershipTypes } from '.';
import { IUserInfo, ILoginData } from './contracts';

@injectable()
export class DashboardLoginClient {

    get routeDefinition(): DashboardLoginRoute {
    ...
    constructor(
        @inject(membershipTypes.DashboardLoginRoute) protected loginRoute: DashboardLoginRoute,
