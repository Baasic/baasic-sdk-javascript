/* globals module */
/**  
 * @module dashboardLoginRoute  
 * @description Baasic Dashboard Login Route Definition provides Baasic route templates which can be expanded to Baasic REST URIs. Various services can use Baasic Login Route Definition to obtain needed routes while other routes will be obtained through HAL. By convention, all route services use the same function names as their corresponding services. 
 */
...
@injectable()
export class DashboardLoginRoute extends BaseRoute {
