...
export class TemplatingBatchClient {
    ...
    **/
    create(data: ITemplate[]): PromiseLike<IHttpResponse<IResponse[]>> {
        return this.apiClient.post<IResponse[]>(this.routeDefinition.create(), this.templatingBatchRouteDefinition.createParams(data));
    }
    ...
    update(data: ITemplate[]): PromiseLike<IHttpResponse<IResponse[]>> {
        return this.apiClient.put<IResponse[]>(this.routeDefinition.update(), this.templatingBatchRouteDefinition.updateParams(data));
    }
