...
export class LoginClient {
     ...
     * @example loginClient.loadUserData()
                    ...
                    .finally (function () {});							
     */
    loadUserData(data: any): PromiseLike<IHttpResponse<IPlatformUserInfo>> {
        data = data || {};
        return this.apiClient.get<IPlatformUserInfo>(this.loginRoute.login(data), { 'Accept': 'application/json; charset=UTF-8' });
    }
