...
import { ArticleCommentsRoute, ArticleCommentRepliesClient, CommentStatus, TYPES as articleTypes } from './';
import { IArticleComment, INotificationConfiguration, ICommentStatus } from './contracts';
...
export class ArticleCommentsClient {
    ...
    **/
     ...
     **/
    get routeDefinition(): ArticleCommentsRoute {
    ...
    constructor(
        ...
        @inject(articleTypes.ArticleCommentsRoute) protected articleCommentsRoute: ArticleCommentsRoute,
    ...
    find(options?: IOptions): PromiseLike<IHttpResponse<IQueryModel<IArticleComment>>> {
        return this.apiClient.get<IQueryModel<IArticleComment>>(this.routeDefinition.find(options));
    }
    ...
    **/
    get(id: string, options?: IGetRequestOptions): PromiseLike<IHttpResponse<IArticleComment>> {
        return this.apiClient.get<IArticleComment>(this.articleCommentsRoute.get(id, options));
    }
