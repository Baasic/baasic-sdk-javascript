...
export class ArticleInstanceFilesClient {
    ...
    **/
    update(articleId: string, data: IArticleFile): PromiseLike<IHttpResponse<void>> {
        return this.apiClient.put<void>(this.routeDefinition.update(articleId, data), this.articleInstanceFilesRouteDefinition.updateParams(data));
    }
    ...
    link(articleId: string, data: IArticleFile): PromiseLike<IHttpResponse<IArticleFile>> {
        return this.apiClient.post<IArticleFile>(this.routeDefinition.link(articleId, data), this.articleInstanceFilesRouteDefinition.createParams(data));
    }
}
