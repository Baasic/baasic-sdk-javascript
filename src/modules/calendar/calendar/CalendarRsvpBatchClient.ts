...
export class CalendarRsvpBatchClient {
     ...
     * @param calendar Calendar object that will have its EventRsvp objects craeted
     ...
     * @param calendar A calendar object that will have it's CalendarEventRsvp's updated.
    ...
    **/
     ...
     * @param calendar A calendar object that will have it's calendarEventRsvp's deleted.
     * @returns A promise that is resolved once the remove action has been performed.
     * @example calendarEventRsvpIds are identifiers which uniquely identify CalendarEventRsvp resources.
                    calendarRsvpBatchClient.remove(calendar, calendarEventRsvpIds)
                        .then(function (data) {
                            // perform success action here
                        },
                         function (response, status, headers, config) {
