...
export class CalendarEventRsvpClient {
     ...
     **/
    find(options?: ICalendarOptions): PromiseLike<IHttpResponse<IQueryModel<ICalendarEventRSVP>>> {
     ...
     * @example calendarEventRsvpClient.get()
                    .then(function (data) {
                        // perform success action here
                    },
                     function (response, status, headers, config) {
     ...
     * ```
     * @method
     * @param data A Calendar Event Rsvp object used to update specified CalendarEventRsvp resource.
    ...
    **/
     ...
     * @example     calendarEventRsvpClient.purge()
                        .then(function (data) {
                            // perform success action here
                        },
                        function (response, status, headers, config) {
