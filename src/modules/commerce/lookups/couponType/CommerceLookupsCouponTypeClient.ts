...
@injectable()
export class CommerceLookupsCouponTypesClient {

    get routeDefinition(): CommerceLookupsCouponTypeRoute {
        return this.commerceLookupsCouponTypeRoute;
    }

    get batch(): CommerceLookupsCouponTypesBatchClient {
        return this.commerceLookupsCouponTypesBatchClient;
    }

    constructor(
        @inject(commerceTypes.CommerceLookupsCouponTypeRoute) protected commerceLookupsCouponTypeRoute: CommerceLookupsCouponTypeRoute,
        @inject(commerceTypes.CommerceLookupsCouponTypesBatchClient) protected commerceLookupsCouponTypesBatchClient: CommerceLookupsCouponTypesBatchClient,
