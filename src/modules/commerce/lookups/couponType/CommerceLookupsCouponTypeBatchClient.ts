...
@injectable()
export class CommerceLookupsCouponTypesBatchClient {

    get routeDefinition(): CommerceLookupsCouponTypeBatchRoute {
    ...
    **/
    ...
    remove(ids: string[]): PromiseLike<IHttpResponse<void>> {
        return this.apiClient.delete<void>(this.commerceLookupsCouponTypeBatchRoute.delete(), undefined, ids);
    }
}
