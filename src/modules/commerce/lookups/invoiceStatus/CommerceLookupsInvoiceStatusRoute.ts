...
export class CommerceLookupsInvoiceStatusRoute extends BaseRoute {
    ...
    public readonly getRoute: string = 'commerce/lookups/invoice-statuses/{id}/{?embed,fields}';

    public readonly createRoute: string = 'commerce/lookups/invoice-statuses';

    public readonly updateRoute: string = 'commerce/lookups/invoice-statuses/{id}';
