...
export class CommerceLookupsInvoiceStatusClient {
    ...
    update(data: any): PromiseLike<IHttpResponse<void>> {
        return this.apiClient.put<void>(this.routeDefinition.update(data), this.commerceLookupsInvoiceStatusRouteDefinition.updateParams(data));
    }
    ...
    create(data: any): PromiseLike<IHttpResponse<any>> {
        return this.apiClient.post(this.routeDefinition.create(), this.commerceLookupsInvoiceStatusRouteDefinition.createParams(data));
    }
