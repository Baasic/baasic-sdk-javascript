/* globals module */
/**  
 * @module commerceLookupsInvoiceStatusBatchRouteDefinition  
...
@injectable()
export class CommerceLookupsInvoiceStatusBatchRouteDefinition extends BaseRouteDefinition {

    public readonly createRoute: string = 'commerce/lookups/invoice-statuses/batch';

    public readonly updateRoute: string = 'commerce/lookups/invoice-statuses/batch';

    public readonly deleteRoute: string = 'commerce/lookups/invoice-statuses/batch';
     ...
     * @method                    
     * @example commerceLookupsInvoiceStatusBatchRouteDefinition.create();                      
     */
    create(): any {
     ...
     * @method                
     * @example commerceLookupsInvoiceStatusBatchRouteDefinition.update();                      
     */
    update(): any {
     ...
     * Parses remove commerce country state batch route; this route does not expose any additional options                      
     * @method                    
     * @example commerceLookupsInvoiceStatusBatchRouteDefinition.remove();                      
     */
    delete(): any {
