...
@injectable()
export class BaasicCommerceLookupsRecurringCyclePeriodTypeBatchRouteDefinition extends BaasicBaseRouteDefinition {

    public readonly createRoute: string = 'commerce/lookups/recurring-cycle-period-types/batch';

    public readonly updateRoute: string = 'commerce/lookups/recurring-cycle-period-types/batch';

    public readonly deleteRoute: string = 'commerce/lookups/recurring-cycle-period-types/batch';
