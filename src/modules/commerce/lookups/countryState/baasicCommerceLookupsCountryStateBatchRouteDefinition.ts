...
@injectable()
export class BaasicCommerceLookupsCountryStateBatchRouteDefinition extends BaasicBaseRouteDefinition {

    public readonly createRoute: string = 'commerce/lookups/states/batch';

    public readonly updateRoute: string = 'commerce/lookups/states/batch';

    public readonly deleteRoute: string = 'commerce/lookups/states/batch';
