...
export class CommerceLookupsAddressTypesBatchClient {
    ...
    create(data: any): PromiseLike<IHttpResponse<any>> {
        return this.apiClient.post(this.routeDefinition.create(), this.commerceLookupsAddressTypeBatchRouteDefinition.createParams(data));
    }
    ...
    **/
    update(data: any): PromiseLike<IHttpResponse<void>> {
        return this.apiClient.put<void>(this.routeDefinition.update(), this.commerceLookupsAddressTypeBatchRouteDefinition.updateParams(data));
    }
