...
@injectable()
export class CommerceCouponUseRoute extends BaseRoute {

    public readonly findRoute: string = 'commerce/coupon-uses/{?searchQuery,page,rpp,sort,embed,fields}';

    public readonly getRoute: string = 'commerce/coupon-uses/{id}/{?embed,fields}';

    public readonly createRoute: string = 'commerce/coupon-uses';

    public readonly updateRoute: string = 'commerce/coupon-uses/{id}';

    public readonly deleteRoute: string = 'commerce/coupon-uses/{id}';
     ...
     **/
    find(options?: ICouponUseOptions): any {
