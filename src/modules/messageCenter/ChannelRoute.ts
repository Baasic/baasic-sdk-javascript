...
export class ChannelRoute extends BaseRoute {
    ...
    public readonly getRoute: string ='message-center/channels/{id}/{?embed,fields}'; 

    public readonly updateRoute: string = 'message-center/channels/{id}'; 

    public readonly deleteRoute: string = 'message-center/channels/{id}';

    public readonly purgeRoute: string = 'message-center/channels/purge';

    get batch(): ChannelBatchRoute {
