...
export class MessageBatchRoute extends BaseRoute {

    public readonly createRoute: string = 'message-center/messages/batch';
    public readonly updateRoute: string = 'message-center/messages/batch';
    public readonly deleteRoute: string = 'message-center/messages/batch';
