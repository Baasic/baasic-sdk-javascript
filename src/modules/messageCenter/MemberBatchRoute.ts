...
export class MemberBatchRoute extends BaseRoute {

    public readonly createRoute: string = 'message-center/members/batch';

    public readonly updateRoute: string = 'message-center/members/batch';

    public readonly deleteRoute: string = 'message-center/members/batch';
