...
export class DynamicResourceClient {
    ...
    create(schemaName: string, data: any): PromiseLike<IHttpResponse<IDynamicObject>> {
        return this.apiClient.post<IDynamicObject>(this.routeDefinition.create(schemaName, data), this.dynamicResourceRouteDefinition.createParams(schemaName, data));
    }
    ...
    update(data: any, options: IOptions): PromiseLike<IHttpResponse<void>> {
        return this.apiClient.put<void>(this.routeDefinition.update(data, options), this.dynamicResourceRouteDefinition.updateParams(data));
    }
    ...
    patch(data: any, options: IOptions): PromiseLike<IHttpResponse<void>> {
        return this.apiClient.patch<void>(this.routeDefinition.patch(data, options), this.dynamicResourceRouteDefinition.updateParams(data));
    }
