...
export class NotificationsSubscriptionsUsersBatchRoute extends BaseRoute {
    ...
    public readonly createRoute: string = 'notifications/subscriptions/user/batch';

    public readonly deleteRoute: string = 'notifications/subscriptions/user/batch';

    public readonly updateRoute: string = 'notifications/subscriptions/user/batch';
