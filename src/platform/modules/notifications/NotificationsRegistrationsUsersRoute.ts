...
import { NotificationsRegistrationsUsersBatchRoute, TYPES as notificationsTypes } from './';
import { IUserRegistration } from './contracts';

@injectable()
export class NotificationsRegistrationsUsersRoute extends BaseRoute {

    public readonly createRoute: string = 'notifications/registrations/user';

    public readonly findRoute: string = 'notifications/registrations/user/{?searchQuery,userIds,providers,page,rpp,sort,embed,fields}';

    public readonly getRoute: string = 'notifications/registrations/user/{id}/{?embed}';

    public readonly deleteRoute: string = 'notifications/registrations/user/{id}';

    public readonly updateRoute: string = 'notifications/registrations/user/{id}';
