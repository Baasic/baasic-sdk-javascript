...
export class UserClient {
     ...
     **/
    unlock(data: IPlatformUser): PromiseLike<IHttpResponse<any>> {
     ...
     **/
    lock(data: IPlatformUser): PromiseLike<IHttpResponse<any>> {
     ...
     **/
    approve(data: IPlatformUser): PromiseLike<IHttpResponse<any>> {
     ...
     **/
    disapprove(data: IPlatformUser): PromiseLike<IHttpResponse<any>> {
