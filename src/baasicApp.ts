...
export class BaasicApp implements IBaasicApp {
    ...
    public readonly mediaGalleryModule: modules.MediaGallery.MediaGalleryClient;
    ...
    constructor(private apiKey: string, private options?: Partial<IBaasicOptions>) {
        ...
        this.mediaGalleryModule = this.diModule.kernel.get<modules.MediaGallery.MediaGalleryClient>(modules.MediaGallery.TYPES.MediaGalleryClient);
